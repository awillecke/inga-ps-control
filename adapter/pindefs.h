...
#define PINDEFS_H_
	...
	// Definitions for the December 2011 board
		...
		#define JOY3_BUTTON		7
		#define JOY3_BUTTON_PIN	PINE
		#define JOY4_BUTTON		6
		#define JOY4_BUTTON_PIN	PINE

		#define HANDSFREE_1		5
		#define HANDSFREE_1_PIN PINE
		#define HANDSFREE_2		4
		#define HANDSFREE_2_PIN PINE
		#define HANDSFREE_3		3
		#define HANDSFREE_3_PIN PIND
		#define HANDSFREE_4		4
		#define HANDSFREE_4_PIN PIND
